...
class Details extends StatelessWidget {
  ...
  this.nouval,this.lovelyHearts,this.turkishProducts,this.timeLess,this.favoriteItem,this.shoppingCartItem,this.categoryId, })
      : super(key: key);
                ...
                onTap: () {
                               ...
                               await
                             {
                               favoritesList.add(
                                   FavoritesModel(
                                     //ArabicName
                                       arabic: id==1? featured.arabic: id==2? bestSellers.arabic: id==3? discount.arabic: id==4?newArrival.arabic:
                                       ...
                                       //Image
                                       image:id==1? featured.image: id==2? bestSellers.image: id==3? discount.image: id==4?newArrival.image:
                                       ...
                                       //Name
                                       name:id==1? featured.name: id==2? bestSellers.name: id==3? discount.name: id==4?newArrival.name:
                                       ...
                                       //Price
                                       price:id==1? featured.price: id==2? bestSellers.price: id==3? discount.price: id==4?newArrival.price:
                                       ...
                                       size:id==1? featured.size: id==2? bestSellers.size: id==3? discount.size: id==4?newArrival.size:
